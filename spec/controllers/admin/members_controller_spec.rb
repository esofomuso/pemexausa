...
RSpec.describe Admin::MembersController, type: :controller do
  ...
  # Admin::Member. As you add validations to Admin::Member, be sure to
  ...
  # Admin::MembersController. Be sure to keep this updated too.
  let(:valid_session) { {} }

  describe "GET #index" do
    it "assigns all admin_members as @admin_members" do
      member = Admin::Member.create! valid_attributes
      get :index, {}, valid_session
      expect(assigns(:admin_members)).to eq([member])
    end
  end
  ...
  describe "GET #new" do
    it "assigns a new admin_member as @admin_member" do
      ...
      expect(assigns(:admin_member)).to be_a_new(Admin::Member)
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      it "creates a new Admin::Member" do
        expect {
          post :create, {:admin_member => valid_attributes}, valid_session
        }.to change(Admin::Member, :count).by(1)
      end

      it "assigns a newly created admin_member as @admin_member" do
        post :create, {:admin_member => valid_attributes}, valid_session
        expect(assigns(:admin_member)).to be_a(Admin::Member)
        expect(assigns(:admin_member)).to be_persisted
      end

      it "redirects to the created admin_member" do
        post :create, {:admin_member => valid_attributes}, valid_session
        expect(response).to redirect_to(Admin::Member.last)
      end
    end

    context "with invalid params" do
      it "assigns a newly created but unsaved admin_member as @admin_member" do
        post :create, {:admin_member => invalid_attributes}, valid_session
        expect(assigns(:admin_member)).to be_a_new(Admin::Member)
      end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested admin_member" do
        member = Admin::Member.create! valid_attributes
        put :update, {:id => member.to_param, :admin_member => new_attributes}, valid_session
        member.reload
      ...
      it "assigns the requested admin_member as @admin_member" do
        member = Admin::Member.create! valid_attributes
        put :update, {:id => member.to_param, :admin_member => valid_attributes}, valid_session
        expect(assigns(:admin_member)).to eq(member)
      end
    ...
    context "with invalid params" do
      it "assigns the admin_member as @admin_member" do
        member = Admin::Member.create! valid_attributes
        put :update, {:id => member.to_param, :admin_member => invalid_attributes}, valid_session
        expect(assigns(:admin_member)).to eq(member)
      end
  ...
  describe "DELETE #destroy" do
    ...
    it "redirects to the admin_members list" do
      member = Admin::Member.create! valid_attributes
      delete :destroy, {:id => member.to_param}, valid_session
